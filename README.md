...
- **🐞「排查这次 CICD 流水线报错，看看哪里出了问题」** → 导入流水线日志，分析错误根因并给出修复建议
...
| 平台 | 状态 | 下载 | 源码 | 官方插件地址 |
|------|------|------|------|------|
| Chrome | ✅ 已适配 | [下载](release/AIHelper-chrome.zip) | [下载](release/AIHelper-source.zip) | ⚡ coming soon |
| Firefox | ✅ 已适配 | [下载](release/AIHelper-firefox.zip) | [下载](release/AIHelper-source.zip) | ⚡ coming soon |
| Edge | ✅ 已适配 | [下载](release/AIHelper-chrome.zip) | [下载](release/AIHelper-source.zip) | ⚡ coming soon |
| Opera | ✅ 已适配 | [下载](release/AIHelper-chrome.zip) | [下载](release/AIHelper-source.zip) | ⚡ coming soon |
| 其他 Chromium 内核浏览器 | ✅ 已适配 | [下载](release/AIHelper-chrome.zip) | [下载](release/AIHelper-source.zip) | ⚡ coming soon |
