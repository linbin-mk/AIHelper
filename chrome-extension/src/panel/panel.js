...
function showSkillHistoryOverlay(skillId) {
  ...
  if (hist.length === 0) {
    ...
    for (var i = 0; i < hist.length; i++) {
      ...
      html += '<div class="skill-history-item" data-version-index="' + i + '" data-version-type="history">';
